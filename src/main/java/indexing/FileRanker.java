...
public class FileRanker {
	...
	public void generateScore() {
		...
		while (number < 5) {
			...
			for (Map.Entry<File, Set<String>> entry : getOutgoingMap()
				...
				counterAndo++;
				//System.out.println(counterAndo + "this is the counter");
				// delta = Math.abs(delta - finalScore); // delta is
				// approximately
	...
	public static void main(String[] args) {
		...
		fileIndexer.addFiles(new File(
				"C:\\Users\\andy\\Desktop\\CS 454\\munged"));
